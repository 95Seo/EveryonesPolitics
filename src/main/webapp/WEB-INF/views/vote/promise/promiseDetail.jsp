                    ...
                    <div class="recommend-view-flex">
                        <div class="recommend-view-flex-wrap">
                            <div class="recommend-view-flex-wrap-left">
                                ...
                                <span class="recmmend-span-num"><b><c:out value="${promiseDetail.view_cnt}" /></b></span>
                            </div>
                            <div class="recommend-view-flex-wrap-right">
                                <span class="recommend-span-txt">추천 수</span>
                                <span class="recmmend-span-num"><b><c:out value="${promiseDetail.like_cnt}" /></b></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="view-button-vote">
                <a href="#none" class="view-vote">
                    <div>
                        ...
                        <span id="view-vote-count"><c:out value="${promiseDetail.like_cnt}" /></span>
                    </div>
                    <p>공감</p>
                </a>
                <a href="#none" class="view-declare">
                    <div>
                        ...
                        <span id="view-declare-count"><c:out value="${promiseDetail.dislike_cnt}" /></span>
                    </div>
                    <p>신고</p>
                </a>
            </div>
