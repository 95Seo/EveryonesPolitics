...
<script>
    ...
    var promise_nm = "tb_promise"; //보여줄 페이지
    var promise_idx = JSON.parse ( ${idx} );

    detailCall(promise_nm, promise_idx); //리스트 호출 함수
    ...
    $(document).on("click","div[class=view-vote]",function(){
        ...
        if(check_id == 'guest') {
            ...
            updateLike(promise_nm, promise_idx, like);
        }
    });
    ...
    function updateLike(page,idx,like){
        ...
        obj.success= function(d){
            console.log(d);
            detailCall(promise_nm, promise_idx);
        };

        ajaxCall(obj);
    }

    // /vote/promise/promiseDetail/{page}/{idx}
    // likeCnt - 좋아요 수
    // likeYn - 좋아요 여부
    function detailCall(page,idx){
        obj.url="/vote/promise/promiseDetail/";
        obj.type="get";
        obj.data ={};
        obj.url += page + "/";
        obj.url += idx;
            ...
            <div class="view-wrap">
                <div class="view-box">
                    <div class="view-nav-title">
                        <h2>[<c:out value='${promise.filter}'/>]비하인드</h2>
                    </div>
                    <div class="view-inner-wrap">
                        <div class="view-inner-wrap-01">
                            ...
                            <div class="view-inner-content">
                                <div class="view-title" id="title">
                                    <h2><c:out value="${promise.title}" /></h2>
                                </div>
                                <div class="recommend-view-flex">
                                    <div class="recommend-view-flex-wrap">
                                        <div class="recommend-view-flex-wrap-left">
                                            ...
                                            <span class="recmmend-span-num" id="viewCnt"><b><c:out value="${promise.viewCnt}" /></b></span>
                                        </div>
                        ...
                        <div class="view-txt" id="content">
                            <c:out value="${promise.content}" escapeXml="false" />
                        </div>
                        ...
                        <div class="view-button-box">
                            <div class="view-list-button">
                                <a href="/vote/promiseList?&page=${page}&filter=${filter}&keyword=${keyword}">
                                    <button>목록</button>
                                </a>
                            </div>
                            <c:if test="${principal.role == 'ADMIN'}">
                                <div class="view-button-box-02">
                                    ...
                                    <div class="view-write-button">
                                        <a href="/vote/promiseUpdate?idx=${promise.idx}&page=${page}&filter=${filter}&keyword=${keyword}">
                                            <button>수정</button>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <form name="commentInsertForm" style="margin-bottom: 50px;">
                            <div class="input-group" style="display: flex">
                                ...
                                <div class="input-group-right" style="width: 80%;">
                                    <input type="hidden" name="bno" value="${promise.idx}"/>
                                    <input type="hidden" name="boardNm" value="tb_promise"/>
