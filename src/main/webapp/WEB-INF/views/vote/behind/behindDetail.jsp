...
<script>
    ...
    var behind_nm = "tb_behind"; //보여줄 페이지
    var behind_idx = JSON.parse ( ${idx} );
                            ...
                            <c:if test="${principal.role == 'ADMIN'}">
                                <div class="view-button-box-02">
                                    <div class="view-delete-button">
                                        <a href="/vote/behindDelete?idx=${behind.idx}">
                                            <button>삭제</button>
                                        </a>
                                    </div>
                        ...
                        <form name="commentInsertForm" style="margin-bottom: 50px;">
                            <div class="input-group" style="display: flex">
                                ...
                                <div class="input-group-right" style="width: 80%;">
                                    <input type="hidden" name="bno" value="${behind.idx}"/>
                                    <input type="hidden" name="boardNm" value="tb_behind"/>
